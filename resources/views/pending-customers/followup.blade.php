        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="mb-6">
                ...
                <div class="flex flex-wrap gap-2 items-center">
                    ...
                    <a href="{{ route('pending-customers.followup') }}" class="px-4 py-2 bg-gray-400 text-white rounded-lg hover:bg-gray-500 mr-2">
                        Reset Tanggal
                    </a>

                    <form action="{{ route('pending-customers.broadcast-all') }}" method="POST" class="inline sm:ml-auto" onsubmit="return confirm('Apakah Anda yakin ingin mengirimkan broadcast WhatsApp ke semua calon customer pending yang muncul di daftar saat ini?')">
                        @csrf
                                        ...
                                        <div class="flex flex-col gap-1 items-center">
                                            @foreach($dueTypes as $dt)
                                                <div class="flex items-center gap-1 mb-1">
                                                    <form action="{{ route('pending-customers.send-wa', $customer) }}" method="POST" class="inline" onsubmit="return confirm('Kirim WhatsApp {{ $typeLabels[$dt] ?? $dt }} ke {{ addslashes($customer->name) }}?')">
                                                        @csrf
